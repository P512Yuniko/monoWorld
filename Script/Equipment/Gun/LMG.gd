...
var switching = false
var wait = false
var mag = load("res://Screen/Asset/Entity/Mag/Mag556C.tscn")
var facing = 1
var walk = false
var slide = false
var coiling = false
...
@export var base_ammo = 100
var reverse_ammo = 0
@export var empty_time = 2.2
