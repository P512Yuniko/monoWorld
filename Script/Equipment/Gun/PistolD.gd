...
var fire_mode = 66
var switching = false
var mag = load("res://Screen/Asset/Entity/Mag/Mag9B.tscn")
var facing = 1
var walk = false
var slide = false
var wait = false
...
func magout():
	...
	mag_ins.apply_impulse(Vector2(0, randf_range(50,100)).rotated($Body/MagOut.global_rotation), Vector2())
