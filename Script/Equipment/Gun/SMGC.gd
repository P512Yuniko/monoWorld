...
var fire_mode = 66
var switching = false
var mag = preload("res://Screen/Asset/Entity/Mag/Mag90.tscn")
var facing = 0
var walk = false
var slide = false
var wait = false
...
func current():
	...
	if (firing or buffering > 0) and !fire_delay and can_fire and current_ammo > 0:
		...
		shell_ins.angular_velocity = -5 * facing
		shell_ins.z_index = -3 + facing
		shell_ins.apply_impulse(Vector2(randf_range(-50,50),0).rotated(global_rotation), Vector2())
